...
var assert = require('../nodeunit/lib/assert'),             // @REMOVE_LINE_FOR_BROWSER
    async = require('../nodeunit/deps/async'),       // @REMOVE_LINE_FOR_BROWSER
    nodeunit = require('../nodeunit/lib/nodeunit');  // @REMOVE_LINE_FOR_BROWSER
